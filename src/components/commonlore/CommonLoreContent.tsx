      ...
      <Card bordered={false} className="w-full">
        ...
        <SimpleContent
          contentProps={{
            ...
            text: [
              ...
              "Far Realms: A plane of existence that lies beyond the known multiverse, characterized by eldritch and incomprehensible entities. It is a realm of madness and alien horrors. Even sympathizing with such concepts is forbidden in most material planes including Thaum.",
        ...
        <SimpleContent
          contentProps={{
            title: "Gate Keepers",
            text: [
              "All take their power from Mceeju so all are close to gods in power. In Thaum, Gate Keepers are a topic of interest for many sages and very little about them is known.",
        ...
        <SimpleContent
          contentProps={{
            ...
            text: [
              ...
              "Their offsprings from humans tend to get a disoriented body with partial ancient bodyparts. They live for about a millenia years without aging beyond their thirties, body-wise. They are sterile. Even though some were legends, no half-ancient have been spotted in Thaum in centuries.",
              "The last Ancient Relic dwindled out of existance, causing the Blue Era in Thaum. Steram Wayogo, known as the last half-ancient embarked on a journey across countless marbles sealing Ancient Gates, that once provided a unique magical flow to the Material Planes.",
            ],
          }}
        />
        <Divider />
